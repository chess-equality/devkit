...
| Migration & Cleanup | Remove legacy docs, delete unused paths, verify onboarding flow. | Platform | ✅ Done | Overlay docs refreshed and runtime-config mounts landed across shipped overlays. |
